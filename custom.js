...
// carousel hack
$('#carimg > div:nth-child(1)').addClass('active');
...
// Update Profile
	...
	$('body').on('change', '.sb_files-data1', function(e){
		var fd = new FormData();

        var files_data = $('.form-group .sb_files-data1');
        ...
        fd.append('action', 'upload_cover_pic');
        ...
        $.ajax({
            ...
            success: function(res){
...

				{
    				...
    				$('#user_cover').attr( 'src',res_arr[1]);

					$('#cover-upload').attr('src', res_arr[1]);
...
$('body').on('click', '.user_list', function()
{
	...
	$.post(adforest_ajax_url,	{action : 'sb_get_messages', ad_id:cid, user_id:second_user, receiver:second_user, inbox:prnt }).done( function(response)
	{
		...
		$('#ad_post_id').val(cid)
		$('#sb_loading').hide();
		$('#adforest_res > div > div > div.col-md-4.col-sm-5.col-xs-12').hide();
		$('#adforest_res > div > div > div.col-md-8.clearfix.col-sm-5.col-xs-12.message-content').show();
		$('#adforest_res > section > div > div.col-md-5.col-sm-5.col-xs-12').hide();
		$('#adforest_res > section > div > div.col-md-7.clearfix.col-sm-5.col-xs-12.message-content').show();
		$('#adforest_res > div > div > div.col-md-8.clearfix.col-sm-5.col-xs-12.message-content').append('<a href="javascript:void(0)" class="btn bg-ononyo text-white" id="gobackre">Go back</a>');
		$('#adforest_res > section > div > div.col-md-7.clearfix.col-sm-5.col-xs-12.message-content').append('<a href="javascript:void(0)" class="btn bg-ononyo text-white" id="gobackre">Go back</a>');

		$('#messages').html(response);
	});
});

$('body').on('click', '#gobackre', function()
{
		$('#adforest_res > div > div > div.col-md-4.col-sm-5.col-xs-12').show();
    $('#adforest_res > section > div > div.col-md-5.col-sm-5.col-xs-12').show();

		$('#adforest_res > div > div > div.col-md-8.clearfix.col-sm-5.col-xs-12.message-content').hide();
		$('#adforest_res > section > div > div.col-md-7.clearfix.col-sm-5.col-xs-12.message-content').hide();
});
...
function getCustomTemplate(ajax_url, catId, updateId)
{
	  ...
	  /*For Category Templates*/
        ...
        $(document).on('change', '#buy_sell', function()
        {
             ...
             if($(this).val()=='195|Lost and Found' ){
               ...
               $('#ad_price').hide();
               $('#ad_price_type').val('');
               $('#ad_price_type').parent('div').remove();
               $('#ad_price_type').remove();
               $('#dynamic-fields > div:nth-child(3)').remove();
               $('#ad_currency').parent('div').remove();
               //$('.curreny_class').hide();
             }else{
...
jQuery('#filter').click(function() {
        jQuery('.filter-more').slideToggle("fast");
});
jQuery('#type').click(function() {
        jQuery('.type-more').slideToggle("fast");
});
jQuery('#condi').click(function() {
        jQuery('.condi-more').slideToggle("fast");
});
